...
import { useDPrefixConfig, useDComponentConfig, useWave, useCustomContext, useCollapseTransition, useCustomRef } from '../../hooks';
...
export const DButton = React.forwardRef<HTMLButtonElement, DButtonProps>((props, ref) => {
   ...
   */
  const [loadingEl, loadingRef] = useCustomRef<HTMLLIElement>();
  //#endregion
